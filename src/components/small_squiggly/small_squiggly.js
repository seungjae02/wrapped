import './small_squiggly.css';

function SmallSquiggly(props) {
    return (
        <svg viewBox="0 0 403.44 74.33">
            <path className="small-squiggly" style={{animationDelay: props.delay}} fill="none" stroke={props.color} strokeWidth={props.strokeWidth} 
